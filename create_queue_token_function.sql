-- Create function to generate unique queue token
...
COMMENT ON FUNCTION generate_queue_token() IS 'Generates a unique queue token in format QT-YYYY-XXXX for appointment tracking';
