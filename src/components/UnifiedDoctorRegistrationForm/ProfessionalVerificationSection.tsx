...
import { Award, Upload, FileText, CreditCard, Shield } from 'lucide-react';
import { DoctorFormData } from '../../types/DoctorFormData';

interface ProfessionalVerificationSectionProps {
  formData: DoctorFormData;
  updateFormData: (updates: Partial<DoctorFormData>) => void;
  errors: Record<string, string[]>;
  issuingCouncils: string[];
}

const ProfessionalVerificationSection: React.FC<ProfessionalVerificationSectionProps> = ({
  formData,
  updateFormData,
  errors,
  issuingCouncils
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-lg ${
                errors.medicalRegistrationNumber ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
              placeholder="e.g., MCI-12345 or DMC-67890"
            />
            {errors.medicalRegistrationNumber && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.medicalRegistrationNumber[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-lg ${
                errors.issuingCouncil ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
            >
            ...
            {errors.issuingCouncil && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.issuingCouncil[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-2xl p-6 text-center hover:border-[#0075A2] dark:hover:border-[#0EA5E9] hover:bg-[#F6F6F6] dark:hover:bg-gray-700 transition-all duration-200 group ${
              errors.medicalRegistrationCertificate ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
            }`}>
              <input
                type="file"
            ...
            {errors.medicalRegistrationCertificate && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.medicalRegistrationCertificate[0]}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-lg ${
                errors.aadhaarNumber ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
              placeholder="1234 5678 9012"
              maxLength={14}
            />
            {errors.aadhaarNumber && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.aadhaarNumber[0]}</p>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className={`border-2 border-dashed rounded-2xl p-6 text-center hover:border-[#0075A2] dark:hover:border-[#0EA5E9] hover:bg-[#F6F6F6] dark:hover:bg-gray-700 transition-all duration-200 group ${
                errors.aadhaarFront ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}>
                <input
                  type="file"
                  id="aadhaarFront"
              ...
              {errors.aadhaarFront && (
                <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.aadhaarFront[0]}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className={`border-2 border-dashed rounded-2xl p-6 text-center hover:border-[#0075A2] dark:hover:border-[#0EA5E9] hover:bg-[#F6F6F6] dark:hover:bg-gray-700 transition-all duration-200 group ${
                errors.aadhaarBack ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}>
                <input
                  type="file"
                  id="aadhaarBack"
              ...
              {errors.aadhaarBack && (
                <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.aadhaarBack[0]}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-lg ${
                errors.panNumber ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
              placeholder="ABCDE1234F"
              maxLength={10}
            />
            {errors.panNumber && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.panNumber[0]}</p>
            )}
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-2xl p-6 text-center hover:border-[#0075A2] dark:hover:border-[#0EA5E9] hover:bg-[#F6F6F6] dark:hover:bg-gray-700 transition-all duration-200 group ${
              errors.panCard ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
            }`}>
              <input
                type="file"
                id="panCard"
            ...
            {errors.panCard && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.panCard[0]}</p>
            )}
          </div>
        </div>
      </div>
