...
import { Camera, Stethoscope, GraduationCap, Plus, Trash2, Upload, MessageSquare } from 'lucide-react';
import { DoctorFormData } from '../../types/DoctorFormData';

interface ClinicalProfileSectionProps {
...
const ClinicalProfileSection: React.FC<ClinicalProfileSectionProps> = ({
  formData,
  updateFormData,
  errors,
  specializations,
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="flex-1">
            ...
            <label htmlFor="profilePicture" className="cursor-pointer">
              <div className={`border-2 border-dashed rounded-2xl p-6 text-center hover:border-[#0075A2] dark:hover:border-[#0EA5E9] hover:bg-[#F6F6F6] dark:hover:bg-gray-700 transition-all duration-200 group ${
                errors.profilePicture ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}>
            ...
            {errors.profilePicture && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.profilePicture[0]}</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-semibold text-[#0A2647] dark:text-gray-100 mb-3">
              Specialization * <span className="text-sm text-gray-500 dark:text-gray-400">(Select all that apply)</span>
            </label>
            <div className={`border-2 rounded-2xl p-6 max-h-64 overflow-y-auto bg-white dark:bg-gray-800 shadow-inner ${
              errors.specialization ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
            }`}>
            ...
            {errors.specialization && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.specialization[0]}</p>
            )}
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              min="0"
              max="70"
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-lg ${
                errors.totalYearsOfExperience ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
              placeholder="0"
            />
            {errors.totalYearsOfExperience && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.totalYearsOfExperience[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0075A2] focus:border-[#0075A2] transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-lg resize-none ${
                errors.professionalBio ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
              }`}
              placeholder="Write about your approach, philosophy, and expertise. This will be visible to patients."
            />
            {errors.professionalBio && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.professionalBio[0]}</p>
            )}
          ...
          <div>
            ...
            <div className={`border-2 rounded-2xl p-6 max-h-48 overflow-y-auto bg-white dark:bg-gray-800 shadow-inner ${
              errors.languagesSpoken ? 'border-red-500' : 'border-[#E8E8E8] dark:border-gray-600'
            }`}>
            ...
            {errors.languagesSpoken && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.languagesSpoken[0]}</p>
            )}
          </div>
        </div>
      </div>
